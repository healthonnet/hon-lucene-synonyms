...
#
# Downloads the latest Solr 4.3.0, puts in the synonyms jar, adds a synonyms file, and starts up a local solr on 8983.
#
# Optionally takes solr-4.3.0.tgz as an argument, if you have it.  If not, it wgets it.
#
